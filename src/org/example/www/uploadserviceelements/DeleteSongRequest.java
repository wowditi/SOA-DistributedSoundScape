                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DeleteSongRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DeleteSongRequest",
    ...
    public static class Factory{
        ...
        */
        public static DeleteSongRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DeleteSongRequest object =
                new DeleteSongRequest();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DeleteSongRequest".equals(type)){
                                ...
                                return (DeleteSongRequest)org.example.www.uploadservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
