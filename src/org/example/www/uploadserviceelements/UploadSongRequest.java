                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UploadSongRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UploadSongRequest",
    ...
    public static class Factory{
        ...
        */
        public static UploadSongRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UploadSongRequest object =
                new UploadSongRequest();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UploadSongRequest".equals(type)){
                                ...
                                return (UploadSongRequest)org.example.www.uploadservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
