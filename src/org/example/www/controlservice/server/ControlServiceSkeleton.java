    ...
    public class ControlServiceSkeleton implements ControlServiceSkeletonInterface{
         ...
         */
            ...
            throws ErrorMessage{
                ...
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#setSoundScapeSourceLayout");
        }
         ...
         */
            ...
            throws ErrorMessage{
                //TODO : fill this with the necessary business logic
                throw new  java.lang.UnsupportedOperationException("Please implement " + this.getClass().getName() + "#processPlaybackCommand");
        }
