...
public class ControlServiceMessageReceiverInOut extends org.apache.axis2.receivers.AbstractInOutMessageReceiver {
		...
		try {
			...
			if ((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils
				...
				if ("setSoundScapeSourceLayout".equals(methodName)) {
					...
					org.example.www.controlserviceelements.SetSoundScapeSourceLayoutRequestE wrappedParam = (org.example.www.controlserviceelements.SetSoundScapeSourceLayoutRequestE) fromOM(
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), setSoundScapeSourceLayoutResponse13, false,
							new javax.xml.namespace.QName("http://www.example.org/ControlService/",
				...
				if ("processPlaybackCommand".equals(methodName)) {
					...
					org.example.www.controlserviceelements.ProcessPlaybackCommandRequest wrappedParam = (org.example.www.controlserviceelements.ProcessPlaybackCommandRequest) fromOM(
							msgContext.getEnvelope().getBody().getFirstElement(),
					...
					envelope = toEnvelope(getSOAPFactory(msgContext), processPlaybackCommandResponse15, false,
							new javax.xml.namespace.QName("http://www.example.org/ControlService/",
	...
	private org.apache.axiom.om.OMElement toOM(
			org.example.www.controlserviceelements.SetSoundScapeSourceLayoutRequestE param, boolean optimizeContent)
	...
	private org.apache.axiom.om.OMElement toOM(
			org.example.www.controlserviceelements.SetSoundScapeSourceLayoutResponse param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.om.OMElement toOM(org.example.www.controlserviceelements.ErrorMessage param,
	...
	private org.apache.axiom.om.OMElement toOM(
			org.example.www.controlserviceelements.ProcessPlaybackCommandRequest param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {

		try {
			return param.getOMElement(org.example.www.controlserviceelements.ProcessPlaybackCommandRequestE.MY_QNAME,
					org.apache.axiom.om.OMAbstractFactory.getOMFactory());
		} catch (org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
		}
	...
	private org.apache.axiom.om.OMElement toOM(
			org.example.www.controlserviceelements.ProcessPlaybackCommandResponse param, boolean optimizeContent)
			throws org.apache.axis2.AxisFault {
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
		...
		try {
			...
			emptyEnvelope.getBody().addChild(param.getOMElement(
					org.example.www.controlserviceelements.SetSoundScapeSourceLayoutResponse.MY_QNAME, factory));
	...
	private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
		...
		try {
			...
			emptyEnvelope.getBody().addChild(param.getOMElement(
					org.example.www.controlserviceelements.ProcessPlaybackCommandResponse.MY_QNAME, factory));
	...
	private java.lang.Object fromOM(org.apache.axiom.om.OMElement param, java.lang.Class type,
		...
		try {
			...
			if (org.example.www.controlserviceelements.ErrorMessage.class.equals(type)) {
				...
				return org.example.www.controlserviceelements.ErrorMessage.Factory
			...
			if (org.example.www.controlserviceelements.ProcessPlaybackCommandRequest.class.equals(type)) {
				...
				return org.example.www.controlserviceelements.ProcessPlaybackCommandRequest.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
			...
			if (org.example.www.controlserviceelements.ProcessPlaybackCommandResponse.class.equals(type)) {
				...
				return org.example.www.controlserviceelements.ProcessPlaybackCommandResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
			...
			if (org.example.www.controlserviceelements.SetSoundScapeSourceLayoutRequestE.class.equals(type)) {
				...
				return org.example.www.controlserviceelements.SetSoundScapeSourceLayoutRequestE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
			...
			if (org.example.www.controlserviceelements.SetSoundScapeSourceLayoutResponse.class.equals(type)) {
				...
				return org.example.www.controlserviceelements.SetSoundScapeSourceLayoutResponse.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
