 ...
 */
        ...
        */
        ...
        if((op.getName() != null) && ((methodName = org.apache.axis2.util.JavaUtils.xmlNameToJavaIdentifier(op.getName().getLocalPart())) != null)){
            ...
            if("processPlaybackCommand".equals(methodName)){
                ...
                org.example.www.controlserviceelements.ProcessPlaybackCommandResponse processPlaybackCommandResponse15 = null;
	                        org.example.www.controlserviceelements.ProcessPlaybackCommandRequestE wrappedParam =
                                                             (org.example.www.controlserviceelements.ProcessPlaybackCommandRequestE)fromOM(
                                    msgContext.getEnvelope().getBody().getFirstElement(),
                                    org.example.www.controlserviceelements.ProcessPlaybackCommandRequestE.class,
                                    getEnvelopeNamespaces(msgContext.getEnvelope()));
        ...
        //
            ...
            private  org.apache.axiom.om.OMElement  toOM(org.example.www.controlserviceelements.ProcessPlaybackCommandRequestE param, boolean optimizeContent)
            throws org.apache.axis2.AxisFault {
        ...
        */
        ...
        try {
                ...
                if (org.example.www.controlserviceelements.ProcessPlaybackCommandRequestE.class.equals(type)){
                
                        return org.example.www.controlserviceelements.ProcessPlaybackCommandRequestE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
