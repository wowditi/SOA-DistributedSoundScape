 ...
 */
            ...
            /**
            *  GetSpeakersResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":GetSpeakersResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "GetSpeakersResponse",
    ...
    public static class Factory{
        ...
        */
        public static GetSpeakersResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetSpeakersResponse object =
                new GetSpeakersResponse();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"GetSpeakersResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetSpeakersResponse)org.example.www.registrationservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
