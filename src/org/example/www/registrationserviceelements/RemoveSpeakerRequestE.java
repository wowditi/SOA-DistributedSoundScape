...
public class RemoveSpeakerRequestE implements org.apache.axis2.databinding.ADBBean {

	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://www.example.org/RegistrationServiceElements/", "RemoveSpeakerRequest", "ns2");
	
	public RemoveSpeakerRequestE() {}
	
	public RemoveSpeakerRequestE(GeneralDevice device) {
		RemoveSpeakerRequest innerRequest = new RemoveSpeakerRequest();
		innerRequest.setSpeaker(device);
		setRemoveSpeakerRequest(innerRequest);
	}
	...
	public static class Factory {
		...
		public static RemoveSpeakerRequestE parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			RemoveSpeakerRequestE object = new RemoveSpeakerRequestE();
					...
					if (reader.isStartElement()) {
						...
						if (reader.isStartElement()
								&& new javax.xml.namespace.QName("http://www.example.org/RegistrationServiceElements/",
										"RemoveSpeakerRequest").equals(reader.getName())) {

							object.setRemoveSpeakerRequest(
									org.example.www.registrationserviceelements.RemoveSpeakerRequest.Factory
											.parse(reader));
