...
/**
 * ProcessPlaybackCommandRequest.java
 *
...
/**
 * ProcessPlaybackCommandRequest bean class
 */
@SuppressWarnings({ "unchecked", "unused" })

public class ProcessPlaybackCommandRequest implements org.apache.axis2.databinding.ADBBean {
	/*
	 * This type was generated from the piece of schema that had name =
	 * ProcessPlaybackCommandRequest Namespace URI =
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						namespacePrefix + ":ProcessPlaybackCommandRequest", xmlWriter);
			} else {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type",
						"ProcessPlaybackCommandRequest", xmlWriter);
			}
		...
		localCommand.serialize(new javax.xml.namespace.QName("", "Command"), xmlWriter);
	...
	public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
		...
		elementList.add(new javax.xml.namespace.QName("", "Command"));
	...
	public static class Factory {
		 ...
		 */
		public static ProcessPlaybackCommandRequest parse(javax.xml.stream.XMLStreamReader reader)
				throws java.lang.Exception {
			ProcessPlaybackCommandRequest object = new ProcessPlaybackCommandRequest();
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"ProcessPlaybackCommandRequest".equals(type)) {
							...
							return (ProcessPlaybackCommandRequest) org.example.www.controlservice.ExtensionMapper
