                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           ...
                           xmlWriter);
                                           ...
                                           localIpAddress.serialize(new javax.xml.namespace.QName("","IpAddress"),
                                               xmlWriter);
                                        
                                            if (localPort==null){
                                                 throw new org.apache.axis2.databinding.ADBException("Port cannot be null!!");
                                            }
                                           localPort.serialize(new javax.xml.namespace.QName("","Port"),
                                               xmlWriter);
                                        
                                            if (localSoundScapeId==null){
                                                 throw new org.apache.axis2.databinding.ADBException("SoundScapeId cannot be null!!");
                                            }
                                           localSoundScapeId.serialize(new javax.xml.namespace.QName("","SoundScapeId"),
                                               xmlWriter);
            ...
            try {
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","IpAddress").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","SoundScapeId").equals(reader.getName())){
