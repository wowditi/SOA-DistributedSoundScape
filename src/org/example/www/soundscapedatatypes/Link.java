...
public class Link implements org.apache.axis2.databinding.ADBBean {
	/*
	...
	protected org.example.www.soundscapedatatypes.LinkType localType;

	/**
	 * Auto generated getter method
	 * 
	 * @return org.example.www.soundscapedatatypes.LinkType
	 */
	public org.example.www.soundscapedatatypes.LinkType getType() {
		return localType;
	}
	 ...
	 *            Type
	 */
	public void setType(org.example.www.soundscapedatatypes.LinkType param) {
	...
	public void serialize(final javax.xml.namespace.QName parentQName, javax.xml.stream.XMLStreamWriter xmlWriter,
		...
		if (serializeType) {
			...
			if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)) {
				writeAttribute("xsi", "http://www.w3.org/2001/XMLSchema-instance", "type", namespacePrefix + ":Link",
						xmlWriter);
			} else {
		...
		public static Link parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
			...
			try {
				...
				if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance", "type") != null) {
					...
					if (fullTypeName != null) {
						...
						if (!"Link".equals(type)) {
							...
							return (Link) org.example.www.uploadservice.ExtensionMapper.getTypeObject(nsUri, type,
									reader);
						}
				...
				if (reader.isStartElement() && new javax.xml.namespace.QName("", "Type").equals(reader.getName())) {
					...
					object.setType(org.example.www.soundscapedatatypes.LinkType.Factory.parse(reader));
